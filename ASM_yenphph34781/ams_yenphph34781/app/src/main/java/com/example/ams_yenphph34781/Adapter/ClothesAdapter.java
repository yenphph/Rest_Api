package com.example.ams_yenphph34781.Adapter;
...
import com.example.ams_yenphph34781.R;
import com.example.ams_yenphph34781.databinding.ItemClothesBinding;
...
public class ClothesAdapter extends RecyclerView.Adapter<ClothesAdapter.ViewHolder> {
    ...
    // Thêm phương thức getList() để trả về danh sách quần áo
        ...
        holder.binding.btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (position != RecyclerView.NO_POSITION && clothesClick != null) {
                    clothesClick.deleteItem(position); // Gọi phương thức deleteItem
                }
            }
        });
